...
$(window).load(posStartEngineText);

function posStartEngineText(){
	$("#startEngineText").css("left",get_screen_size()[0]/2 - $("#startEngineText").html().length*5);
	$("#startEngineText").css("top",(get_screen_size()[1]/4)*2 );
}

function startEngine(){

	if(!engineStarted && everyThingHasBeenLoaded ){
		...
		$("#startEngineText").css("display","none");
		$("#lightsOff").addClass("lightFlash");
		$("#lightsOff").css("opacity",0);
		setTimeout(function(){
			$("#lightsOff").css("display","none");
			$("#lightsOff").removeClass("lightFlash");
		},1000);	
