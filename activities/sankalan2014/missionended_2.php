...
function hideit(){
	...
	<body style="position: static; ">
		...
		<div id="content" >
			...
			<a title="error 404" href="sankalan.info">
			<img style="position: absolute; left: 30%; top: 18%; transform: rotate(-3.281027deg);"  src="antigravity/404.png" class="box2d" >
			</a>

			<span style="position: absolute; left: 40%; top: 25%; transform: rotate(-2.281027deg);" class="box2d">
			<h1 style="font-size:50px;  color: #00FCFF; text-shadow: 2px 1px 2px #88D2E7;">We can't find the page you are looking for</h1>
			
			<h2 style=" color: #00FCFF; text-shadow: 2px 1px 2px #67C8FF;">:(</h2>
			</span><br>
