...
//-- stary On Demand Settings ONLY
var _uacct="";			// set up the stary Account
...
var _ugifpath2="starfieldwa_files/__utm.gif";
if (_udl.hash) _udlh=_udl.href.substring(_udl.href.indexOf('#'));
if (_udl.protocol=="https:") _ugifpath2="starfieldwa_files/__utm.gif";
if (!_utcp || _utcp=="") _utcp="/";
function staryTracker(page) {
...
function _uCO() {
 ...
 sc.id="_gasojs";
 sc.src='https://'+d+''+_utk+'&'+Math.random();
