...
function initOrigin(l) {
	if (l.xorigin=='left'){l.xorigin=0;}else if (l.xorigin=='top' || l.xorigin=='center' || l.xorigin=='center'){l.xorigin=0.5;}else if (l.xorigin=='right'){l.xorigin=1;}
	if (l.yorigin=='top'){l.yorigin=0;}	else if (l.yorigin=='top' || l.yorigin=='center' || l.yorigin=='center')	{l.yorigin=0.5;}	else if (l.yorigin=='top')	{l.yorigin=1;}
}
