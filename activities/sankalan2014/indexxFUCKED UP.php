...
<body onload="initPage()" onresize="resizePage()" onmousewheel="return false;" onscroll="scrollTo(0,0);" >
<!-- <body> -->
...
<div id="fb-root"></div>
	...
	<div id="icons">
		...
		<!-- <div style="position:absolut	e;left: 10px;"><iframe src="//www.facebook.com/plugins/like.php?href=https%3A%2F%2Fwww.facebook.com%2FDUCS.Sankalan&amp;width&amp;layout=box_count&amp;action=like&amp;show_faces=false&amp;share=true&amp;height=65" scrolling="no" frameborder="0" style="border:none;width:50px" overflow:hidden; height:65px;" allowTransparency="true"></iframe>	</div> -->
	...
	<div id="topConsole">
			...
			<div class="console topConsoleBottomPlate" id="topConsoleBottomPlateLeft">
				<marquee scrolldelay=5 scrollamount=2 class="news" id="newsTopLeft" onclick="news_fall()" ><a style="color:black;text-decoration: none;" href="javascript:news_fall()">We Are proud to launch the website for SANKALAN 2014</a></marquee>
			</div>
	...
	<div id="bottomConsole">
		...
		<div id="speedControls">
			...
			{
				echo "<a href='javascript:register_form_fall()' class='button3d' id='regButton'>Register</a><!--<a href='#registwer' class='button3d' id='regButton'>Register</a>-->";
			}?>
			<!-- <a href="javascript:FBLogin()" class="button3d">Register</a> -->
	...
	<div class="load" style="position:absolute;top:50%;left:48%;width:100px;color:#fff;z-index:900;">Loading...</div>
	...
	<div  id="wrapper" style="position:relative;">
		...
		<!-- <div class="pages" id="my_page" style="width:100%;">

		<div class="neonPage" style="position:absolute">

		<div style="width:30%">
		</div>

		<div style="width:30%;float:left;position:absolute;top:0px;">
		</div>
