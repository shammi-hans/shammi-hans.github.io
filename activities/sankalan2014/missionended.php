...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
		...
		<title>Sankalan 2014 Ended</title> 
...
function hideit(){
	...
	<body style="position: static; ">
		...
		<div id="audiotag">
<audio controls onloadeddata="var audioPlayer = this; setTimeout(function() { audioPlayer.play(); }, 9000)" autobuffer loop>
  <source src="audio/starwars.ogg" type="audio/ogg">
  <source src="audio/starwars.mp3" type="audio/mpeg">
  Oops! Your browser is not supporting audio. Time to upgrade.
</audio>
	</div>
		
  <iframe style="position:absolute; z-index:-100; top:0px;left:0px; width:100%; height:100%;" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="starfieldwa.html"></iframe>
  

  	<p id="hideable" class="blink" style="font-size: 20px; position:absolute; z-index:1000; top:66%; left:33%; color:rgb(252, 36, 36); margin-top:0px; text-shadow: 10px 0px 20px rgb(237, 99, 99),0 0 60px #FFF, 0 0 10px #FFF;">
 	Meanwhile, click and drag the floating objects.
  	</p>
			<table id="topbar" >
			<tbody><tr >
				<td   style="position: absolute;width:485px; height:57px; transform: rotate(0.227858deg); background-image:url(images/parts/lnotif.png); color:#000;"  bgcolor="#000" class="box2d" >
				<span><marquee style=" margin-left:30px; margin-right:30px;  text-shadow: 1px 1px 0 #BBFFFF; font-size:15px; ">Sankalan ended with a great success and congratulations to all the winners</marquee>
				</span></td>
				<td id="topbar2"  style="position: absolute; left: 485.5px; top: 0.1%; transform: rotate(-0.280771deg);" class="box2d">
				<span >
				<a style="font-size: 38px; color: #00FCFF; text-shadow: 2px 1px 2px #67C8FF;">
				SANKALAN-2014</a>
				</span>
				</td>
				
				
				<td  class="box2d empty" bgcolor="#000" style="width:485px; height:57px; position: absolute; right:1px; transform: rotate(-3.62904deg); background-image:url(images/parts/rnotif.png);" >
				<span><marquee  style=" margin-left:30px; margin-right:30px;  color:#000; text-shadow: 1px 1px 0 #BBFFFF; font-size:15px;">Sankalan ended with a great success and congratulations to all the winners</marquee>
				</span></td>
			</tr>
		</tbody></table>
		...
		<table >
			<tr><td>
				<span style="position: absolute; left: 8%; top: 15%; transform: rotate(2.1542deg);" class="box2d">
				<h2 style=" color: #00FCFF; text-shadow: 2px 1px 2px #67C8FF;">The</h2>
				</span>
				<span style="position: absolute; left: 12.5%; top: 15%; transform: rotate(2.4509deg);" class="box2d">
				<h2 style=" color: #00FCFF; text-shadow: 2px 1px 2px #67C8FF;">Annual</h2>
				</span>
				<span style="position: absolute; left: 20%; top: 15%; transform: rotate(2.79126deg);" class="box2d">
				<h2 style=" color: #00FCFF; text-shadow: 2px 1px 2px #67C8FF;">Technical</h2>
				</span>
				<span style="position: absolute; left: 30%; top: 15%; transform: rotate(3.15752deg);" class="box2d">
				<h2 style=" color: #00FCFF; text-shadow: 2px 1px 2px #67C8FF;">Festival</h2>
				</span>
				<span style="position: absolute; left: 38.5%; top: 15%; transform: rotate(3.21247deg);" class="box2d">
				<h2 style=" color: #00FCFF; text-shadow: 2px 1px 2px #67C8FF;">of</h2>
				</span>
				<span style="position: absolute; left: 41.3%; top: 15%; transform: rotate(2.90609deg);" class="box2d">
				<h2 style=" color: #00FCFF; text-shadow: 2px 1px 2px #67C8FF;">Department</h2>
				</span>
				<span style="position: absolute; left: 54%; top: 15%; transform: rotate(-0.470115deg);" class="box2d">
				<h2 style=" color: #00FCFF; text-shadow: 2px 1px 2px #67C8FF;">of</h2>
				</span>
				<span style="position: absolute; left: 57%; top: 15%; transform: rotate(-0.423265deg);" class="box2d">
				<h2 style=" color: #00FCFF; text-shadow: 2px 1px 2px #67C8FF;">Computer</h2>
				</span>
				<span style="position: absolute; left: 67.5%; top: 15%; transform: rotate(-0.25529deg);" class="box2d">
				<h2 style=" color: #00FCFF; text-shadow: 2px 1px 2px #67C8FF;">Science,</h2>
				</span>
				<span style="position: absolute; left: 76%; top: 15%; transform: rotate(-3.58143deg);" class="box2d">
				<h2 style=" color: #00FCFF; text-shadow: 2px 1px 2px #67C8FF;">University</h2>
				</span>
				<span style="position: absolute; left: 87%; top: 15%; transform: rotate(-0.501378deg);" class="box2d">
				<h2 style=" color: #00FCFF; text-shadow: 2px 1px 2px #67C8FF;">of</h2>
				</span>
				<span style="position: absolute; left: 89.5%; top: 15%; transform: rotate(-3.00906deg);" class="box2d">
				<h2 style=" color: #00FCFF; text-shadow: 2px 1px 2px #67C8FF;">Delhi</h2>
				</span></td>
			</tr>
		</table>
		...
		<div id="content" >
			<!-- panel -->
			<div id="panelwa">
			<img  id="panelwa1" style="position: absolute; left: 20px; bottom: 17px; width: 490px; height:215px; transform: rotate(-0.413909deg);" id="logo" src="images/parts/lpanel.png" class="box2d" >
			<img id="panelwa2" style="position: absolute; left: 385px; bottom: 45px;  width: 602px;  height:190px; transform: rotate(-0.413909deg);" id="logo" src="images/parts/mpanel.png" class="box2d" >
			<img id="panelwa3" style="position: absolute; left: 840px; bottom: 23px;  width: 490px;  height:215px; transform: rotate(-0.413909deg);" id="logo" src="images/parts/rpanel.png" class="box2d" >
			</div>
			<!-- /panel -->

			<span style="position: absolute; color: #08F8FB; font-family: Arial; font-size: 12px; right: 16%; bottom: 25%;  transform: rotate(-4.45318deg);"  class="box2d">SANKALAN.INFO</span>

			<a title="Who bothers now !">
			<img style="position: absolute; left: 33.5%; bottom: 25%;     transform: rotate(-0.281027deg);"  src="images/parts/events.png" class="box2d"  >
			</a>
			<a title="Well, the count is less.." >
			<img style="position: absolute; left: 39.5%; bottom: 25%;     transform: rotate(-0.281027deg);"  src="images/parts/sponsors.png" class="box2d"  >
			</a>
			<a href="sankalan.info" >
			<img style="position: absolute; left: 47%; bottom: 25%;     transform: rotate(-0.281027deg);"  src="images/parts/home.png" class="box2d" >
			</a>
			<a title="Its about DUCS" >
			 <img style="position: absolute; left: 51.8%; bottom: 25%;     transform: rotate(-0.281027deg);"  src="images/parts/aboutus.png" class="box2d" >
			</a>
			<a title="See you after a light year">
			<img style="position: absolute; left: 59.5%; bottom: 25.1%;     transform: rotate(-0.281027deg);"  src="images/parts/schedule.png" class="box2d" >
			</a>
			<a  href="../gallery/srijan.php">			
			<img style="position: absolute; left: 37%; bottom: 18%;     transform: rotate(-1.281027deg);"  src="images/parts/srijan.png" class="box2d"  >
			</a>
			<a title="switch error">
			<img style="position: absolute; left: 43.5%; bottom: 18%;     transform: rotate(-3.281027deg);"  src="images/parts/off.png" class="box2d" >
			</a>
			<a title="Hyper Drive is not working :(">
			<img style="position: absolute; left: 48%; bottom: 18%;     transform: rotate(-2.281027deg);" id="hyperdrive" src="images/parts/hyperdrive.png" class="box2d" >
			</a>
			<a  title="Gear box error">
			<img style="position: absolute; left: 57%; bottom: 16%;     transform: rotate(-5.281027deg);"  src="images/parts/speed.png" class="box2d">
			</a>

			<a  href="./android/Sankalanv1.0.apk">
			<img style="position: absolute; left:10px; top: 20%;     transform: rotate(-0.281027deg);"  id="sidewala" src="images/android.png" class="box2d">
			</a>

			<a  href="https://www.facebook.com/DUCS.Sankalan">
			<img style="position: absolute; left:5px; top: 27%;     transform: rotate(-2.481027deg);"  id="sidewala" src="images/fbIcon.png" class="box2d">
			</a>
			<a >
			<img style="position: absolute; left:0px; top: 26.5%;     transform: rotate(3.481027deg);"  id="sidewala" src="images/parts/cover1.png" class="box2d">
			</a>

			<a >
			<img style="position: absolute; left: 5px; top: 38%;     transform: rotate(2.781027deg);"  id="sidewala" src="images/phn.png" class="box2d">
			</a>
			<a >
			<img style="position: absolute; left: 0px; top: 37.5%;     transform: rotate(3.781027deg);"  id="sidewala" src="images/parts/cover2.png" class="box2d">
			</a>
			
			<a>
			<img style=" position: absolute; left: 5px; top: 50%;  transform: rotate(-0.481027deg);"  id="sidewala" src="images/parts/lyk.png" class="box2d">
			</a>

			<span style="position: absolute; left: 25%; top: 25%;  transform: rotate(-0.281027deg);" id="sidewala" class="box2d">
			<img src="images/parts/mainLogo.png">
			</span>
			<span style="position: absolute; left: 40%; top: 25%; transform: rotate(-2.281027deg);" class="box2d">
			<h1 style="font-size:50px;  color: #00FCFF; text-shadow: 2px 1px 2px #67C8FF;">SANKALAN 2014</h1>
			</span>
			<span style="position: absolute; left: 55%; top: 35%; transform: rotate(-0.281027deg);" class="box2d">
			<h2 style=" color: #00FCFF; text-shadow: 2px 1px 2px #67C8FF;">Compiling Innovations</h2>
			</span><br>
    ...
    color: #BBFFFF;
    position: absolute;
    text-shadow: 2px 1px 2px #67C8FF;
     left: 35%; width: 490px; transform: rotate(-4.66442deg);" href="sankalan.info" class="box2d">Copyright &copy; 2014 
     </a>
     <a style="position: absolute;
    font-size: 17.075px;
    ...
    position: absolute;
    text-shadow: 2px 1px 2px #67C8FF;
     left: 48%; ; transform: rotate(-4.66442deg);" href="sankalan.info" class="box2d"> Sankalan, Delhi University
     </a>
		...
		<script src="antigravity/api1" type="text/javascript"></script>
		<script>
		...
		<script>
			...
			function panelwahide(){
				
				setTimeout(chotu1,100);
				function chotu1(){

				document.getElementById('panelwa1').style.position="fixed";
				document.getElementById('panelwa2').style.position="fixed";
				document.getElementById('panelwa3').style.position="fixed";
				
				document.getElementById('panelwa1').style.top='800px';
				document.getElementById('panelwa2').style.top='800px';
				document.getElementById('panelwa3').style.top='800px';

				document.getElementById('sidewala').style.left='10%';

				document.getElementById('panelwa1').style.left='5%';
				document.getElementById('panelwa2').style.left='5%';
				document.getElementById('panelwa3').style.left='5%';

				document.getElementById('panelwa').style.top='99%';
				document.getElementById('panelwa').style.zIndex='999';

				document.getElementById('panelwa1').style.width='35%';
				document.getElementById('panelwa2').style.width='35%';
				document.getElementById('panelwa3').style.width='35%';
				document.getElementById('panelwa1').style.height='35%';
				document.getElementById('panelwa2').style.height='35%';
				document.getElementById('panelwa3').style.height='35%';


				document.getElementById('topbar').style.position="fixed";


				document.getElementById('topbar').style.zIndex='999';

				document.getElementById('panelwa1').style.zIndex='999';
				document.getElementById('panelwa2').style.zIndex='999';
				document.getElementById('panelwa3').style.zIndex='999';

				document.getElementById('topbar').style.top='-3px';


				
				}
				
				setTimeout(chotu2,300);
				function chotu2(){
				document.getElementById('topbar').style.top='-6px';

				document.getElementById('panelwa1').style.width='30%';
				document.getElementById('panelwa2').style.width='30%';
				document.getElementById('panelwa3').style.width='30%';
				document.getElementById('panelwa1').style.height='30%';
				document.getElementById('panelwa2').style.height='30%';
				document.getElementById('panelwa3').style.height='30%';

				}
				
				setTimeout(chotu3,500);
				function chotu3(){
				document.getElementById('topbar').style.top='-10px';

				document.getElementById('panelwa1').style.width='25%';
				document.getElementById('panelwa2').style.width='25%';
				document.getElementById('panelwa3').style.width='25%';
				document.getElementById('panelwa1').style.height='25%';
				document.getElementById('panelwa2').style.height='25%';
				document.getElementById('panelwa3').style.height='25%';

				}
				
				setTimeout(chotu4,700);
				function chotu4(){
				document.getElementById('topbar').style.top='-15px';

				document.getElementById('panelwa1').style.width='20%';
				document.getElementById('panelwa2').style.width='20%';
				document.getElementById('panelwa3').style.width='20%';
				document.getElementById('panelwa1').style.height='20%';
				document.getElementById('panelwa2').style.height='20%';
				document.getElementById('panelwa3').style.height='20%';

				}
				
				setTimeout(chotu5,900);
				function chotu5(){
				document.getElementById('topbar').style.top='-20px';

				document.getElementById('panelwa1').style.width='15%';
				document.getElementById('panelwa2').style.width='15%';
				document.getElementById('panelwa3').style.width='15%';
				document.getElementById('panelwa1').style.height='15%';
				document.getElementById('panelwa2').style.height='15%';
				document.getElementById('panelwa3').style.height='15%';
				}
				
				setTimeout(chotu6,1100);
				function chotu6(){
				document.getElementById('topbar').style.top='-25px';

				document.getElementById('panelwa1').style.width='10%';
				document.getElementById('panelwa2').style.width='10%';
				document.getElementById('panelwa3').style.width='10%';
				document.getElementById('panelwa1').style.height='10%';
				document.getElementById('panelwa2').style.height='10%';
				document.getElementById('panelwa3').style.height='10%';
				}
				
				setTimeout(chotu7,1300);
				function chotu7(){
				document.getElementById('topbar').style.top='-30px';

				document.getElementById('panelwa1').style.width='5%';
				document.getElementById('panelwa2').style.width='5%';
				document.getElementById('panelwa3').style.width='5%';
				document.getElementById('panelwa1').style.height='5%';
				document.getElementById('panelwa2').style.height='5%';
				document.getElementById('panelwa3').style.height='5%';
				}

				setTimeout(chotu8,1500);
				function chotu8(){
				document.getElementById('topbar').style.top='-35px';

				document.getElementById('panelwa1').style.width='3%';
				document.getElementById('panelwa2').style.width='3%';
				document.getElementById('panelwa3').style.width='3%';
				document.getElementById('panelwa1').style.height='3%';
				document.getElementById('panelwa2').style.height='3%';
				document.getElementById('panelwa3').style.height='3%';

				}

				setTimeout(chotu9,1700);
				function chotu9(){
				document.getElementById('topbar').style.top='-40px';


				document.getElementById('panelwa1').style.display="none";
				document.getElementById('panelwa2').style.display="none";
				document.getElementById('panelwa3').style.display="none";
				

			}

				setTimeout(chotu10,1900);
				function chotu10(){
				document.getElementById('topbar').style.top='-45px';
				}

				setTimeout(chotu10,2100);
				function chotu10(){
				document.getElementById('topbar').style.top='-50px';
				
				}

				setTimeout(chotu10,2300);
				function chotu10(){
				document.getElementById('topbar').style.top='-55px';
				}
				
				setTimeout(chotu10,2500);
				function chotu10(){
				document.getElementById('topbar').style.top='-60px';
				}	

				setTimeout(chotu10,2700);
				function chotu10(){
				document.getElementById('topbar').style.top='-65px';
				}

				setTimeout(chotu10,2900);
				function chotu10(){
