...
<body   onmousewheel="return false;" onscroll="scrollTo(0,0);" > <!--Smi has changed onload="initPage()" -->

<!-- <body> -->

<span style="position:absolute; z-index:1000; left:-270px; top:4%; ">
...
<div style="position:absolute;top:0px;left:0px;height:100%;width:100%;background-color:rgba(0,0,0,0.5);z-index:900;" id="results" onclick="location.href = 'missionended.php';"> <!--Smi has changed onclick="hidemedam()" -->


<div style="position:absolute;right:10px;top:0px;color:#fff;font-size:20px;cursor:pointer;" onclick="location.href = 'missionended.php';"><!--Smi has changed onclick="hidemedam()" -->


</div>
<div style="top:0px;left:0px;color:#fff;position:absolute;width:100%;">
...
<h2 class="blink" style="color: #FFF; margin-top:0px; text-shadow: 10px 0px 20px rgb(237, 99, 99),0 0 60px rgb(252, 36, 36), 0 0 10px #FFF; ">
