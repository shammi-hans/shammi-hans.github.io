...
<div style="position:absolute;top:0px;left:0px;height:100%;width:100%;background-color:rgba(0,0,0,0.5);z-index:900;" id="results" onclick="hidemedam()"> 

<div style="position:absolute;right:10px;top:0px;color:#fff;font-size:20px;cursor:pointer;" onclick="hidemedam()">
<p>X</p>

</div>

<div style="top:30%;left:0px;color:#fff;position:absolute;width:100%;">
